    ...
    public function index()
    {
        ...
        try {
            ...
            if (!($goodsView['payLimitFl'] == 'y' && $goodsView['payLimit'] == 'gb')) {
                ...
                $naverPayButton = $naverPay->getNaverPayView(Request::get()->get('goodsNo'), true);
                $naverPayPcButton = $naverPay->getNaverPayView(Request::get()->get('goodsNo'));
                ...
                if ($paycoCheckoutbuttonImage !== false) $this->setData('payco', gd_isset($paycoCheckoutbuttonImage));
            }
       ...
       /* $board = new BoardList(['bdId'=>Board::BASIC_GOODS_REIVEW_ID]);
        ...
        if (empty($displayField['goodsDisplayStrikeField']['mobile']) === true) {
            ...
            foreach ($displayField['goodsDisplayStrikeField']['mobile'] as $val) {
                ...
                if ($val == 'goodsPrice' && $goodsView['couponPrice'] > 0) {
                    $goodsPriceTag = '<del>';
                    $goodsPriceTag2 = '</del>';
                }
            }
