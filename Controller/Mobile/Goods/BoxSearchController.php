...
class BoxSearchController extends \Controller\Mobile\Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $goodsData = $goods->getBoxSearchList($cateCd, $cateMode, $pageNum,$displayOrder, gd_isset($cateInfo['imageCd']), $optionFl, $soldOutFl, $brandFl, $couponPriceFl,null,$displayCnt,$getValue['m_goodsWidth'],$getValue['m_goodsDepth'],$getValue['m_goodsHeight'],$getValue['m_limit']);
